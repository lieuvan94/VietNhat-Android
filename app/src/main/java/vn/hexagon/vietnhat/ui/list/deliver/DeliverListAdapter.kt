...
import vn.hexagon.vietnhat.databinding.LayoutItemListServiceDeliverBinding
 ...
 * =====================================================
 */
class DeliverListAdapter (private val context: Context?,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_deliver,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceDeliverBinding -> {
                ...
                if (currentList[position].roadType == "1") {
                    binding.itemSubContent.text = Constant.ROAD_VN_JP
                } else {
                    binding.itemSubContent.text = Constant.ROAD_JP_VN
                }
                ...
                // Handle onClick item
                binding.deliverListItemArea.setOnClickListener {
