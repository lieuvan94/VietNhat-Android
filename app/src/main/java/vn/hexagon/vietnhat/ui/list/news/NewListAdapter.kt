 ...
 * =====================================================
 */
class NewListAdapter(private val viewModel: PostListViewModel,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_new,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceNewBinding -> {
                binding.position = position
                binding.viewmodel = viewModel
                binding.imageView.clipToOutline = true
                // Handle onClick item
                binding.newListItemArea.setOnClickListener {
