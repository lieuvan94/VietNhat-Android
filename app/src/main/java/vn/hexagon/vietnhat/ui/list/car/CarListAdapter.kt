 ...
 * =====================================================
 */
class CarListAdapter (private val viewModel: PostListViewModel,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_car,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceCarBinding -> {
                binding.position = position
                binding.viewmodel = viewModel
                var isAdded = false
                binding.carListItemImg.clipToOutline = true
                ...
                binding.carListItemArea.setOnClickListener {
