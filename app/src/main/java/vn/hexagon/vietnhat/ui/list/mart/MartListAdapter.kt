...
import vn.hexagon.vietnhat.databinding.LayoutItemListServiceMartBinding
 ...
 * =====================================================
 */
class MartListAdapter(private val viewModel: PostListViewModel,
                      private val onClick:(String,String) -> Unit,
                      private val onClickFav:(Boolean) -> Unit) :
    BaseAdapter<Post>(ListDiffCallback()) {
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_mart,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when (binding) {
            is LayoutItemListServiceMartBinding -> {
                binding.position = position
                binding.viewmodel = viewModel
                var isAdded = false
                binding.previewImg.clipToOutline = true
                binding.martListItemArea.setOnClickListener {
