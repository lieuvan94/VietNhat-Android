...
import vn.hexagon.vietnhat.databinding.LayoutItemListServiceTravelBinding
 ...
 * =====================================================
 */
class TravelListAdapter(private val context: Context?,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_travel,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceTravelBinding -> {
                binding.position = position
                binding.viewmodel = viewModel
                var isAdded = false
                binding.travelListItemImg.clipToOutline = true
                ...
                // Handle onClick item
                binding.travelListItemArea.setOnClickListener{
    ...
    private fun TextView.priceStateProcess(position: Int, isLogin: Boolean) {
        if (isLogin) {
            this.apply {
                text = resources.getString(R.string.dynamic_price_per_people,
