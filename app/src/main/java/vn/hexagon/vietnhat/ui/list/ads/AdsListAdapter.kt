 ...
 * =====================================================
 */
class AdsListAdapter (private val context: Context?,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_ads,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceAdsBinding -> {
                ...
                // Handle onClick item
                binding.adsListItemArea.setOnClickListener {
        ...
        if (isLogin) {
            this.apply {
                text = resources.getString(
                    ...
                    String.format(
                        "%,d",
                        WindyConvertUtil.filterNumeric(currentList[position].price).toInt()
                    )
                )
