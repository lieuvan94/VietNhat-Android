...
import vn.hexagon.vietnhat.databinding.LayoutItemListServiceSpaBinding
 ...
 * =====================================================
 */
class SpaListAdapter (private val viewModel: PostListViewModel,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_spa,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceSpaBinding -> {
                binding.position = position
                binding.viewmodel = viewModel
                var isAdded = false
                binding.spaListItemImg.clipToOutline = true
                ...
                // Handle onClick item
                binding.spaListItemArea.setOnClickListener {
