...
import vn.hexagon.vietnhat.databinding.LayoutItemListServiceRestaurantBinding
 ...
 * =====================================================
 */
class RestaurantListAdapter (private val viewModel: PostListViewModel,
    ...
    override fun createBinding(parent: ViewGroup, viewType: Int): ViewDataBinding {
        return if (viewType == Constant.LIST_ITEM_TYPE) {
            DataBindingUtil.inflate(
                ...
                R.layout.layout_item_list_service_restaurant,
                parent,
                false
            )
        } else {
    ...
    override fun bind(binding: ViewDataBinding, position: Int) {
        when(binding) {
            is LayoutItemListServiceRestaurantBinding -> {
                ...
                // Handle onClick item
                binding.restaurantListItemArea.setOnClickListener {
